...
<section class="content-header">
  <h1> <?php echo $this->lang->line("requested Amount"); ?> </h1>
  ...
  <div class="row" >
    <div class="col-xs-12">
        <div class="grid_container" style="width:100%; min-height:600px;">
            ...
            url="<?php echo base_url()."admin/requested_amount_list"; ?>" 
            ...
            <!-- url is the link to controller function to load grid data -->
                ...
                <thead>
                    <tr>
                        ...
                        <th field="last_name" sortable="true" ><?php echo $this->lang->line("Lirst Name"); ?></th>
                        <th field="email_id" sortable="true" ><?php echo $this->lang->line("User Email"); ?></th>
                        <th field="wallet" sortable="true" ><?php echo $this->lang->line("Amount"); ?></th>
                        <th field="paytm_phone_number" sortable="true" ><?php echo $this->lang->line("Paytm Phone Number"); ?></th>
                        <th field="paytm_email_id" sortable="true"><?php echo $this->lang->line("Paytm Email ID"); ?></th>                     
                        <th field="status" formatter='request_status' sortable="true"><?php echo $this->lang->line("status"); ?></th>                     
                        <th field="created_date" ><?php echo $this->lang->line("Requested Date"); ?></th>    
                        <th field="action" formatter='action_column'><?php echo $this->lang->line("Action"); ?></th>    
...
<script> 
    ...
    {      
      ...
      var status = row.status;
      var str="";
      if(status=='done') str="<label class='label label-success'>"+"<?php echo $this->lang->line('accepted'); ?>"+"</label>";
