				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-md-6 col-lg-6">
							...
							<input type="button" class="btn btn-sm btn-danger" value="Back" onclick="removeSession()">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-md-6 col-lg-6">
							<input name="isbn" value="<?php echo set_value('isbn');?>"  class="form-control" id="isbn" type="text" autofocus="on">
		...
		$(function() {
			...
			$("#isbn").on('change',function(e){
				...
				var word = $("#isbn").val();				
				 ...
				 $.get("https://www.goodreads.com/search/index.xml?q=9780749469078&key=8qo4PHyzSrEHzIiNvWXqQg&search=all&format=json&user_id=33770104", function(data, status){
					console.log(data);
					if(data.totalItems > 0){
						$(".found").addClass("hide");
						handleResponse(data);
