...
<section class="content-header">
	<section class="content">
		<div class="box box-info custom_box">
			...
			<form class="form-horizontal" action="<?php echo site_url().'admin/update_book_action/'.$info['id'];?>" enctype="multipart/form-data" method="POST" id="bookForm">
				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-md-6 col-lg-6">
							<input name="vendor" value="<?php if(set_value('vendor')) echo set_value('vendor');else {if(isset($info['vendor'])) echo $info['vendor'];}?>"  class="form-control" type="text" id="vendor">		          
							<span class="red"><?php echo form_error('vendor'); ?></span>
						</div>
					</div> 
					<div class="form-group">
