...
<section class="content-header">
  <h1> <?php echo $this->lang->line("Order Labeling"); ?> </h1>
  ...
  <div class="row">
    <div class="col-xs-12">
        ...
        <div class="grid_container" style="width:100%; height:700px;">
            ...
            url="<?php echo base_url()."librarian/labeling_list_data"; ?>" 
		...
		<div id="tb" style="padding:3px">
            <form class="form-inline" style="margin-top:20px"  enctype="multipart/form-data">
				...
				<div class="pull-right">
					<input type="button" class="btn btn-success" value="Send to Delivery" id="bulkChange" />
				</div>
            </form>
        </div>        
    </div>
...
var plan_id = 0;   
    ...
    {    
		...
		str += "<input type='button' class='btn btn-success btn-sm' value='Request Delivery' onclick='deliveryConfirmation("+row.id+")' >";
        return str;
    } 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
				<form name="stockForm" method="POST" > 
					<p>Are you sure to submit to Delivery?</p>
				</form>	
            </div> 
