...
<?php
    if($this->session->userdata('book_isbn_file_name')==1)
    {
        ...
        $edit_permission    = 1;
        $delete_permission  = 1;
        $stockadd_permission  = 1;
?>
<!-- Content Header (Page header) -->
<div class='alert alert-success text-center hide' id="st_update"><h4 style='margin:0;'>
	<i class='fa fa-check-circle'></i>Stock Updated Successfully<br/>
</div>
<div class='alert alert-danger text-center hide' id="err_update"><h4 style='margin:0;'>
	<i class='fa fa-check-circle'></i>Error in updating stock<br/>
</div>
    ...
    <div class="col-xs-12">
            ...
            >
                ...
                <thead>
                    <tr>
                        ...
                        <th field="book_id_field" formatter='book_id_show' sortable="true"><?php echo $this->lang->line("book id"); ?></th>                        
                        <th field="vendor" fsortable="true"><?php echo $this->lang->line("vendor"); ?></th>                        
                        ...
                        <th field="category_name" sortable="true" ><?php echo $this->lang->line("Genre"); ?> </th>
                        <th field="edition" sortable="true" ><?php echo $this->lang->line("edition"); ?> </th>
                        <th field="add_date" sortable="true" ><?php echo $this->lang->line("created date"); ?> </th>        
       ...
       <div id="tb" style="padding:3px">
            ...
            <form class="form-inline" style="margin-top:20px"  enctype="multipart/form-data">
				...
				<div class="form-group">
                    <input id="vendor" name="vendor" class="form-control" size="15" placeholder="<?php echo $this->lang->line("Vendor"); ?>">
                </div>   
...
<script>  
    ...
    {               
        ...
        var stockadd_permission="<?php echo $stockadd_permission; ?>";   
		...
		/* if(stockadd_permission==1)     
        str=str+"<a title='"+'<?php echo $this->lang->line("Add Stock") ?>'+"' style='cursor:pointer' id='addStock' onclick='addStock(this)'>"+' <img src="<?php echo base_url("plugins/grocery_crud/themes/flexigrid/css/images/add_book1.png");?>" alt="View">'+"<input type='hidden' value='"+row.id+"' class='bkid'></a>"; */
        ...
        str=str+"<a style='cursor:pointer' title='"+'<?php echo $this->lang->line("delete") ?>'+"' href='#' onclick='deleteBook("+row.id+")'>"+' <img src="<?php echo base_url("plugins/grocery_crud/themes/flexigrid/css/images/close.png");?>" alt="Delete">'+"</a>";
...
function stock(e){
	...
	$.ajax({
			url : base_url+'admin/updateStock',
			data:{
				stock : stock_value,
				id: book_id
			},
			...
			success:function(response){
				if(response == 'success'){
					$('#st_update').removeClass('hide');
					$('#err_update').addClass('hide');
					$("#stockmodal").modal('hide');
				}else {
					$('#st_update').addClass('hide');
					$('#err_update').removeClass('hide');
					$("#stockmodal").modal('hide');
				}
			}
		}) 
    ...
    function deleteBook(id){
		...
		if(con){
			window.location.href = base_url+'admin/delete_book_action/'+id;
		}
	}
		...
		$("#btnExport").click(function(e) { 
			...
			if(seleceted_rows.length != "" && seleceted_rows.length != 0 ){
				var table = "<table><tr><th>Book ID</th><th>Vendor</th><th>ISBN</th><th>Title</th><th>Author</th><th>Edition</th><th>Created Date</th></tr>";
				for(var i=0; i < seleceted_rows.length; i++){
					table += "<tr><td>"+seleceted_rows[i]['id']+"</td><td>"+seleceted_rows[i]['vendor']+"</td><td>"+seleceted_rows[i]['isbn']+"</td><td>"+seleceted_rows[i]['title']+"</td><td>"+seleceted_rows[i]['author']+"</td><td>"+seleceted_rows[i]['edition']+"</td><td>"+seleceted_rows[i]['add_date']+"</td></tr>"
				}
				table += "</table>";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 id="new_search_details_title" class="modal-title"><i class="fa fa-cloud-upload"></i> Import Book from Excel</h4>
            </div><br/>
            ...
            <div class="modal-body">
                ...
                <br/>
                <br/>
                <br/><span ><a target="_BLANK" class="btn btn-sm btn-primary" href="<?php echo base_url("assets/sample/book_import_sample.xls"); ?>"><i class="fa fa-cloud-download"></i> Download Sample Excel</a></span> 
            </div>   
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 id="new_search_details_title" class="modal-title"><i class="fa fa-cloud-upload"></i> Add Stock</h4>
            </div><br/>
            ...
            <div class="modal-body">
                     <form name="stockForm" method="POST" >            
                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<label class="col-sm-3 control-label" ><?php echo $this->lang->line("Add Stock"); ?> 
							</label>
						...
						<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="col-sm-9 col-md-6 col-lg-6">
								 <a class='btn btn-success' onclick="stock(event)"><i class="fa fa-upload"></i> Add</a> 
							</div>
						</div>    
					</form>						
