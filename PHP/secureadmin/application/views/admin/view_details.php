...
<div class="container-fluid">
	<div class="row">
		<div class="col-xs-12 own">
			<center><strong class="text-info" style="font-family:'Cooper Black'; font-size:20px"><i class="fa fa-book"></i> <?php echo $this->lang->line("view"); ?> - <?php echo $this->lang->line("book"); ?></strong></center>
		</div>
	</div>
	<br/>
	<!-- setting variables -->
						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
								<blockquote>
									...
									<footer><?php if(isset($info[0]['physical_form'])) echo $this->lang->line($info[0]['physical_form']); ?></footer>
								</blockquote>
							</div>
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
								<blockquote>
									...
									<footer><?php  if(isset($info[0]['size1'])) echo $this->lang->line($info[0]['size1']); ?></footer>
								</blockquote>
							</div>
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
								<blockquote>
									...
									<footer><?php if(isset($info[0]['source_details'])) echo $this->lang->line($info[0]['source_details']); ?>
									</footer>
								</blockquote>
							</div>
							</div> 
