...
<div id='main-table-box custom_box'>
	<?php echo form_open( $insert_url, 'method="post" class="form-horizontal" id="crudForm" autocomplete="off" enctype="multipart/form-data"'); ?>
		<div class='form-div'>
		   ...
		   <div class="form-group <?php echo $even_odd?>" id="image_field_box">
             <label class="col-sm-3 control-label" for="name" id="image_display_as_box">
             	 Category Image<span class='required'>*</span> 
             </label>
             <div class="col-sm-9 col-md-6 col-lg-6" id="image_input_box">
